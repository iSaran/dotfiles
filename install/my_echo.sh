...
red_echo() {
    echo -e "\x1b[1;31m[Error] $SELF_NAME: $MESSAGE\e[0m"
}
...
green_echo() {
    echo -e "\x1b[1;32m[Success] $SELF_NAME: $MESSAGE\e[0m"
}
...
blue_echo() {
    echo -e "\x1b[1;34m[Info] $SELF_NAME: $MESSAGE\e[0m"
}
